              ...
              <div className="flex-grow">
                <span className="block xl:text-lg font-semibold truncate">
                  {`AED ${convertNumbThousand(
                    rangePrices[0] / 1000
                  )} ~ AED ${convertNumbThousand(rangePrices[1] / 1000)}`}
                </span>
                  ...
                  <div>
                    ...
                    <div className="mt-1 relative rounded-md">
                      <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                        <span className="text-neutral-500 sm:text-sm">AED</span>
                      </div>
                      <input
                        type="text"
                        disabled
                        name="minPrice"
                        id="minPrice"
                        className="focus:ring-primary-500 focus:border-primary-500 block w-full pl-11 pr-3 sm:text-sm border-neutral-200 rounded-full text-neutral-900"
                  ...
                  <div>
                    ...
                    <div className="mt-1 relative rounded-md">
                      ...
                      <input
                        ...
                        name="maxPrice"
                        id="maxPrice"
                        className="focus:ring-primary-500 focus:border-priring-primary-500 block w-full pl-11 pr-5 sm:text-sm border-neutral-200 rounded-full text-neutral-900"
