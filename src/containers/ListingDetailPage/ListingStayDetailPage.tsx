    ...
    return (
      <div className="listingSection__wrap !space-y-6">
        ...
        <div className="flex justify-between items-center">
         <button type="button"  className="btn btn-light" style={{color:'black'}}>Download Catalog</button>
          <LikeSaveBtns />
        </div>
    ...
    return (
      <div className="listingSectionSidebar__wrap shadow-xl">
        ...
        <div className="flex justify-between">
          <span className="text-3xl font-semibold">AED 119</span>
          <StartRating />
        </div>
        ...
        <div className="flex flex-col space-y-4">
         ...
         <input type='email' name='email' placeholder="Enter Email" className="form-control"/>
          ...
          <div className="flex justify-between font-semibold">
         <input type='number' name='number' placeholder="Enter Contact Number" className="form-control"/>
          ...
          <div className="flex justify-between font-semibold">
         <textarea  name='message' placeholder="Type message" className="form-control"/>
        ...
        {/* SUBMIT */}
        {/* <ButtonPrimary href={"/checkout"}>Submit</ButtonPrimary> */}
